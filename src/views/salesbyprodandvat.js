Vue.component("vue-salesbyprodandvat", {
    props: ["data"],
    template: `<div class="salesbyprodandvat">
<section class="box box-medium">
	<header>
		<nav class="browser">
			<ul>
				<li><a href="?p=home">Accueil</a></li>
				<li><h1>TVA par Produits</h1></li>
			</ul>
		</nav>
		<nav class="navbar">
		<form id="tickets-filter" onsubmit="javascript:salesbyprodandvat_filter();return false;">
