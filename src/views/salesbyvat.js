Vue.component("vue-salesbyvat", {
	props: ["data"],
	template: `<div class="salesbyvat">
<section class="box box-medium">
	<header>
		<nav class="browser">
			<ul>
				<li><a href="?p=home">Accueil</a></li>
				<li><h1>TVA par Catégorie</h1></li>
			</ul>
		</nav>
		<nav class="navbar">
		<form id="tickets-filter" onsubmit="javascript:salesbyvat_filter();return false;">
			...
			<div class="form-group">
				...
				<label for="include-zero">Inclure les catégories sans vente</label>
			</div>
			<div class="form-group">
