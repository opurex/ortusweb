...
<div class="col-md-8">
	<div class="box">
		<div class="box-body">
			...
			<p>Bonjour {{user}}. Vous êtes connectés sur {{server}}.</p>
			...
			{{/hasData}}
			{{^hasData}}
			<p>Aucune donnée n'a été chargée. Cliquez sur le bouton ci-dessous pour charger vos données.</p>
			{{/hasData}}
			...
			<ul>
				<li><a href="https://fr.wikibooks.org/wiki/Past%C3%A8que_%28logiciel%2r">Manuel d’installation, de configuration et d’utilisation sur wikibooks</a></li>
