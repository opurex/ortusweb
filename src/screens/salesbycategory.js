    ...
    vue.screen.data = {
        ...
        "table": {
            ...
            "columns": [
                ...
                {reference: "quantity", label: "Quantité", visible: true, help: "La quantité de produits vendus sur la période."},
                {reference: "priceSell", label: "Total ventes HT", visible: false, help: "Le montant de chiffre d'affaire hors taxes réalisé par les produits de la catégorie sur la période concernée."                },
                {reference: "priceBuy", label: "Total achats HT", visible: false, help: "Le prix d'achat hors taxes actuel. Ce montant n'a pas d'historique et ne correspond pas forcément au prix d'achat au moment de la vente."                },
                {reference: "margin", label: "Marge", visible: false, help: "La marge réalisée sur les ventes des produits sur la période. Cette marge est calculée en fonction du prix d'achat actuel et non du prix d'achat au moment de la vente."                },
                {reference: "priceSellVat", label: "Ventes TTC", visible: false, help: "Le montant de chiffre d'affaire TTC réalisé par les produits de la catégorie sur la période concernée."                },
            ],
        },
    }
